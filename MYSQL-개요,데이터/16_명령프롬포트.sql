/*
초기에 SQL문을 명령 프롬포트(CMD) 창에서 작성 후 출력 결과 수정 확인
...
처럼 UI(USER INTERFACE) 화면이 구현된 프로그램이 개발되어 SQL개발을 편하게 할 수 있도록 제공
...
mysql 종료하길 원한다면 exit를 작성하거나 오른쪽 위에 있는 x표시 누르면 종료 가능

아래 ↓ 명령프롬포트에서 mysql 사용 예제
