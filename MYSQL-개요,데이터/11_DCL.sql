...
-- JUNIOR 가 이상한 행동을 하는 것 같음. 기존에 부여한 권한 중 INSERT UPDATE 회수
REVOKE INSERT, UPDATE ON KHUSER.user TO 'JUNIOR'@'%';

-- JUNIOR 가 이상한 행동을 보이는게 맞음! 혹시모르니 모든 권한 회수
